...
namespace MCMyVault
{
    class Common
    {
        ...
        /// <summary>
        /// Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\MCMyVault\\eihort-0.3.11-win64\\eihort.exe"
        /// </summary>
        ...
        /// <summary>
        /// Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + "\\MCMyVault\\eihort-0.3.11-win32\\eihort.exe"
        /// </summary>
