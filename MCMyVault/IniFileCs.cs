...
//MODIFIED version 2012-09-3: ALLOWED COMMENTS ON ONE LINE ONLY
...
public class IniFile
{
    ...
    /// Added by JPSIII 2012-08-28
    /// </summary>
    /// <param name="sSection"></param>
    /// <returns></returns>
    public bool HasSection(string sSection)
    {
        return m_sections.ContainsKey(sSection);
    }
